        ...
        <h2 class="headline headline--small-plus t-center">Upcoming Events</h2>
          <?php
            ...
            while($homepageEvents -> have_posts()){
              ...
              // Second argument 'excerpt' wordpress add dash so in our event teplate folder it will look for a file event-excerpt or we can call a function thats live inside file  like get_post_type()
