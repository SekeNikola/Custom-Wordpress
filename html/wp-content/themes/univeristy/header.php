      ...
      <div class="site-header__menu group">
        <nav class="main-navigation">
          ...
          <li <?php if (get_post_type() == 'program') echo 'class="current-menu-item"' ?>><a href="<?php echo site_url('/programs')?>">Programs</a></li>
            ...
            <!-- We use get_post_type == 'post' because all posts are related to blog -->
        ...
        <div class="site-header__util">
          ...
          <span id="search" class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true"></i></span>
        </div>
      </div>
    </div>
  </header>
